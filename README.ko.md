...
### 0. DevSecOps 개요
  - 개요
    1. [Wikipedia](https://en.wikipedia.org/wiki/DevOps#DevSecOps,_shifting_security_left)와 [Grokipedia](https://grokipedia.com/page/DevOps#devsecops-and-security-integration)의 DevSecOps
